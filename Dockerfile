# This dockerfile uses extends image https://hub.docker.com/sinlov-go/gitea-client-wrapper
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/gitea-client-wrapper/main.go
...
ENTRYPOINT [ "/app/gitea-client-wrapper" ]
# CMD ["/app/gitea-client-wrapper", "--help"]